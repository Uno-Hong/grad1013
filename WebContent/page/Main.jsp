   ...
   <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">사용자가 누른 좋아요를 토대로 인기명소를 골랐어요~!</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <!-- Portfolio item 1-->
                        <div class="portfolio-item">
                            <a class="portfolio-link" href="test_1.jsp">
                                <img class="img-fluid" src="/grad/img/slide_image_1.jpg" id = "image_1">
                            </a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" href="test_1.jsp">
                                <img class="img-fluid" src="/grad/img/slide_image_2.jpg" alt="...">
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" href="test_1.jsp">
                                <img class="img-fluid" src="/grad/img/slide_image_3.jpg" alt="...">
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">테스트 2</div>
                                <div class="portfolio-caption-subheading text-muted">테스트 2</div>
      ...
      <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">사용자가 누른 좋아요를 토대로 인기맛집를 골랐어요~!</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <!-- Portfolio item 1-->
                        <div class="portfolio-item">
                            <a class="portfolio-link" href="test_1.jsp">
                                <img class="img-fluid" src="/grad/img/slide_image_1.jpg">
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading text-center">테스트 1</div>
                                <div class="portfolio-caption-subheading text-muted">테스트 1</div>
