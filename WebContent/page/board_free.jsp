...
<jsp:useBean id="getCount" class="grad.FreeDAO" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%
	...
	try{
		...
		String sql = "select article_index, article_title, user_id, article_hit, left(article_date,10) from tb_user_review where step >=" + start + " and step <= " + end + " order by step asc";
...
<body>
	...
	<%	
			...
			while (rs.next()){
				...
				article_title = rs.getString(2);
				user_id = rs.getString(3);
				article_hit = rs.getInt(4);
				article_date = rs.getString(5);
	...
	%>		
			<tr>
				...
				<td style="text-align: left;">
					<a href="board_view.jsp?article_index=<%=article_index%>&pg=<%=pg %>"><%= article_title%>
					<%
